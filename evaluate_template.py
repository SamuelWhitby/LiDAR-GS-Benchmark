...
"""INSERT ALGORITHM LIBRARIES"""

### -- Adjustable Variables -- ###

## Algorithm Name ##
algorithm_name = 'INSERT ALGORITHM NAME'   #<----------------------------------------------------------------------------------------
...
base_dir = os.path.join(cur_dir, 'scans/')
ontology_file = os.path.join(cur_dir, 'ontology.csv')
results_file = os.path.join(cur_dir, 'results.xlsx')
visulalisation = os.path.join(cur_dir, 'visualise.py')
        ...
        for attribute_folder in os.listdir(environment_path):
            ...
            for group_folder in sorted(os.listdir(attribute_path)):
                ...
                for f in range(len(frames)):
                    ...
                    ground_estimate = """RUN GROUND ESTIMATION HERE"""  # run ground estimation algorithm <-------------------------------------------------------------------------------
                    end_time = time.time()
